...
//Author: Vũ Nguyễn Đức Trí - MSSV: 2500115657
...

{
    class Program
    {
        ...
        {
            //Thiết lập mà hóa đầu ra để hỗ trợ Tiếng Việt
            Console.OutputEncoding = System.Text.Encoding.UTF8;
            //Bài 1: Sắp xếp nổi bọt (Bubble Sort)
            //Yêu cầu: Nhập vào một mảng số nguyên, sử dụng thuật toàn Bubble Sort để sắp xếp mảng theo thứ tự tăng dần.
            ...
            InsertionSort(arr);
            Console.WriteLine("Mang sau khi sap xep thang bang Insertion Sort: ");
            PrintArray(arr);
        }
        ...
        static void PrintArray(int[] arr) {
            //Sử dụng vòng lặp foreach để in tửng phần tử của mảng
            foreach (int num in arr) {
                //In phần tử hiện tại của một khoảng trắng sau nó
                Console.Write(num + " ");
            }
            Console.WriteLine();
        }
        ...
        //thành hai phần: phần đã sắp xếp và phần chưa sắp xếp. Thuật toán sẽ lấy từng phần tử từ phần chưa sắp xếp và chèn nó
        //vào vị trí thích hợp vào phần đã sắp xếp.
        static void InsertionSort(int[] arr) 
        {
            ...
            for (int i = 1; i < n; i++) 
            {
                ...
                int key = arr[i];
                //Biến j để duyệt ngược lại phần để sắp xếp
                int j = i - 1;
