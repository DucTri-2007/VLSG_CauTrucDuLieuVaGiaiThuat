...
//code:
//Sử dụng Console.ReadLine() để gán biển.
{
    class Program
    {
...
//Dùng int.Parse() để chuyển về số nguyên trước khi tính toán.
...
//Yêu cầu: Cho 2 biến x = 5, y = 10. Hãy hoán đổi giá trị của chúng để x = 10, y = 5.
//Hướng dẫn: Hãy tưởng trượng em có 2 ly nước xanh và đỏ,
//để đổi nước cho nhau em cần thêm 1 ly rỗng (biển temp).
        int x = 5, y = 10;
        Console.WriteLine($"Truoc khi swap: x = {x}, y = y{y}");
        int temp = x; //temp = 5
        x = y; //x = 10
        y = temp; //y = 5
